...
public class DownExcelt {
	...
	private String is_firstLogin;//是否第一次登陆
	private String delete_flg;//是否删除
	private String create_user;//创建者
	private String create_time;//创建时间
	private String update_user;//更新者
	private String update_time;//更新时间
	public DownExcelt(String staff_id, String staff_name, Integer degree_id, Integer pro_title_id, Integer college_id,
			Integer dept_id, Integer pro_id, String email, String phone, String mobile, String create_user,
	...
	public String toString() {
		return "DownExcelt [staff_id=" + staff_id + ", staff_name=" + staff_name + ", sex=" + sex + ", degree_id="
				+ degree_id + ", pro_title_id=" + pro_title_id + ", college_id=" + college_id + ", dept_id=" + dept_id
				+ ", pro_id=" + pro_id + ", email=" + email + ", is_dimission=" + is_dimission + ", phone=" + phone
				+ ", mobile=" + mobile + ", is_firstLogin=" + is_firstLogin + ", delete_flg=" + delete_flg
