  ...
  <body>
	...
	<div class="div1">
		...
		<table>
			...
			<tr>
				<td align="right" style="color: #ffffff">原密码:</td>
				<td><input class="input" type="password" name="loginpass" id="loginpass" value="${user.loginpass }"/></td>
				<td><label id="loginpassError" class="error"></label></td>
			</tr>
			<tr>
				<td align="right" style="color: #ffffff">新密码:</td>
				<td><input class="input" type="password" name="newloginpass" id="newpass" value="${user.newloginpass }"/></td>
				<td><label id="newpassError" class="error"></label></td>
			</tr>
			<tr>
				<td align="right" style="color: #ffffff">确认密码:</td>
			...
			<tr>
				...
				<td>
		    	  ...
		    	  <a href="javascript:_change();" style="color: #ffffff">看不清，换一张</a>
				</td>
			</tr>
			<tr>
				<td align="right" style="color: #ffffff">验证码:</td>
				<td>
