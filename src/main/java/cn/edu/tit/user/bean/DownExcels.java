...
public class DownExcels {
	...
	public DownExcels(String stu_id, String stu_name, String class_id, int pro_id, String qq, String mobile,
			String role_id, int college_id, int dept_id, String create_user, String create_time, String update_user,
			String update_time) {
		super();
		this.stu_id = stu_id;
